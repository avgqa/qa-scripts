...
def AM_WebApp_Edit_Account_205(log_file):
    ...
    NewName=("1405931588109.png")
    SaveChanges=("1404914048588.png")
    NewAddress=("1405932736985.png")
    NewUsername=("1405933195003.png")
    Notes=("1405942929057.png")
    NewNotes=("1405943002608.png")
    ...
    hover(Item)
    click(Settings)
    AM_common.verify(log_file,NewName)
    ...
    AM_common.verify(log_file,SaveChanges)
    click(SaveChanges)
    AM_common.verify(log_file,NewAddress)
    AM_common.verify(log_file,Item)
    hover(Item)
    click(Settings)
    ...
    hover(Item)
    click(Settings)
    AM_common.verify(log_file,NewUsername)
    ...
    hover(Item)
    click(Settings)
    AM_common.verify(log_file,NewNotes)
    AM_common.verify(log_file,SaveChanges)
    click(SaveChanges)    
...
if __name__ == "__main__":
    ...
    try:
        ...
        AM_WebApp_Edit_Account_205(log_file)
        AM_common.delItem(log_file)
